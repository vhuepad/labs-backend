...
public class ResourceServerConfiguration extends ResourceServerConfigurerAdapter{
    ...
    private final static String[] publicResources = new String[]{ "/registro/nuevo-usuario/rol/**", "/roles" };
    private final static String[] userResources = new String[]{ "/usuario/**", "/registro/nuevo-rol/**" };
